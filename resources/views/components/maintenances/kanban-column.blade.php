@props(['status', 'title', 'maintenances', 'badgeColorClass' => 'badge-neutral'])
...
<div class="flex flex-col h-full">
    ...
    <!-- Column Content -->
    <div class="overflow-y-auto flex-1 px-2 pt-2 space-y-2 rounded-lg border-dashed -2">
        @forelse($maintenances as $maintenance)
            <x-maintenances.maintenance-card :maintenance="$maintenance" />
        @empty
