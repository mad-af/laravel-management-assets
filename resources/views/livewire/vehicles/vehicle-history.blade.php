<x-info-card title="History" icon="o-clock">
    {{-- <div class="overflow-x-auto"> --}}
        <div class="gap-1 min-w-max tabs tabs-box w-fit tabs-sm">
            <input type="radio" name="history_tabs" class="tab" aria-label="Odometer Log" wire:model.live="activeTab"
                value="odometer" />
            <input type="radio" name="history_tabs" class="tab" aria-label="Maintenance History"
