<x-info-grid title="Vehicle Profile Information" icon="o-truck" :items="[
        ...
        [
            ...
            'value' => $vehicle->vehicleProfile->last_service_date ? $vehicle->vehicleProfile->last_service_date->format('d M Y') : '-'
        ],
        [
            'label' => 'Next Service Date',
            'value' => $vehicle->vehicleProfile->next_service_date ? $vehicle->vehicleProfile->next_service_date->format('d M Y') : '-'
        ],
        [
            'label' => 'Annual Tax Due Date',
            'value' => $vehicle->vehicleProfile->annual_tax_due_date ? $vehicle->vehicleProfile->annual_tax_due_date->format('d M Y') : '-'
        ],
    ]" :longTextItems="[
        [
            'label' => 'Description',
