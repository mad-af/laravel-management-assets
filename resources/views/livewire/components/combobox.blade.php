            ...
            @forelse($options as $opt)
                ...
                @if(!$multiple)
                    <li class="">
                        ...
                        @endphp
                        <label
                            class="list-row py-2.5 cursor-pointer hover:bg-base-300/60 {{ $isSelected ? 'bg-base-300/60' : '' }}">
                ...
                @else
                    <li class="">
                        ...
                        <label class="list-row py-2.5 cursor-pointer hover:bg-base-300/60 {{ $isSelected ? 'bg-base-300/60' : '' }}"
                            ...
                            <input type="checkbox" name="{{ $id }}" class="mr-2 checkbox checkbox-sm" wire:model.live="value"
                                value="{{ $optValue }}" />
                            <div class="grow">
                                <div class="flex gap-2 items-center">
                                    @if($avatarUrl)
