            ...
            <div class="card-body">
                ...
                <form class="space-y-4">
                    <div class="flex items-center gap-4">
                        <x-avatar src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp"
                            size="3xl" alt="Profile" />
                        <div>
                    ...
                    <div class="form-control">
                        ...
                        <textarea class="textarea textarea-bordered"
                            placeholder="Tell us about yourself...">Software developer passionate about creating amazing user experiences.</textarea>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="space-y-4">
                    ...
                    <div class="form-control mt-4">
                        <button type="button" class="btn ">Setup Authenticator App</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-col gap-2">
                        <button type="button" class="btn  btn-warning">Export Account Data</button>
                        <button type="button" class="btn  btn-error">Deactivate Account</button>
