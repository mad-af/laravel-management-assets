...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Tambah Pajak Kendaraan Baru</h1>
        <p class="text-gray-600">Tambahkan data pajak kendaraan baru ke sistem</p>
    </div>

    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('vehicle-taxes.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="tax_period_start" id="tax_period_start" value="{{ old('tax_period_start') }}" 
                ...
                <div>
                    ...
                    <input type="date" name="tax_period_end" id="tax_period_end" value="{{ old('tax_period_end') }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
