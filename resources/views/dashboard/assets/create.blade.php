    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div class="flex gap-4 items-center">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-base-content">Tambah Asset Baru</h1>
                    <p class="mt-1 text-base-content/70">Buat asset baru untuk sistem manajemen.</p>
                </div>
            </div>
        </div>
        ...
        <div class="shadow-xl card bg-base-100">
            <div class="card-body">
                <h2 class="mb-4 text-lg font-semibold card-title">Form Tambah Asset</h2>
                ...
                <form action="{{ route('assets.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="code" value="{{ old('code') }}" placeholder="AST-001"
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Laptop Dell"
                ...
                @endforeach
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="value" value="{{ old('value') }}" placeholder="1000000" step="0.01"
