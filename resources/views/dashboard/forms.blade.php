        ...
        <div class="card-body">
            ...
            <form class="space-y-4">
                <div class="form-control">
                    ...
                    <input type="text" placeholder="This is valid" class="input input-bordered input-success" value="john@example.com" />
                    <label class="label">
                ...
                <div class="form-control">
                    ...
                    <input type="text" placeholder="This has an error" class="input input-bordered input-error" value="invalid-email" />
                    <label class="label">
                ...
                <div class="form-control">
                    ...
                    <input type="text" placeholder="This has a warning" class="input input-bordered input-warning" value="short" />
                    <label class="label">
