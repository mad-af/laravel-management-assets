...
<head>
    ...
    <style>
        /* Hilangkan scroll agar benar-benar satu halaman */
        html,
        body {
            height: 100%;
            overflow: hidden;
...
<body class="bg-base-200 text-base-content">
    ...
    <main class="container relative px-4 pt-4 mx-auto">
            ...
            <nav class="rounded-2xl border shadow-sm backdrop-blur navbar bg-base-100/80 border-base-200">
                <div class="flex gap-2 justify-between items-center py-2 w-full">
                    <div class="flex gap-3 items-center">
                        <span class="inline-flex justify-center items-center w-9 h-9 rounded-xl bg-primary/10">
                            <i data-lucide="boxes" class="w-5 h-5 text-primary"></i>
                        </span>
                        <div>
                            <h1 class="text-lg font-semibold leading-tight">Asset Management</h1>
                            <p class="-mt-0.5 text-xs opacity-40">MVP • Desain Bento • Compact</p>
                        </div>
                    </div>
        ...
        <section class="grid grid-cols-12 gap-4 bento-grid h-[calc(100vh-140px)] mt-3"
            style="--row-h: calc((100vh - 140px - 16px)/2); grid-template-rows: 1.25fr 0.75fr;">
            <!-- Kartu Utama (Hero): lebih tinggi dari kartu 1, berada di atas kartu 1 -->
            <article class="overflow-hidden col-span-12 shadow-sm lg:col-span-7 card bg-base-100">
                <div class="flex relative flex-col h-full card-body">
                    <div class="flex gap-3 justify-between items-start">
                        <div class="space-y-2 max-w-xl">
                            <div class="badge badge-primary badge-outline">MVP</div>
                            <h2 class="text-2xl font-semibold leading-snug">Satu Dashboard untuk Semua Aset</h2>
                        ...
                        <span class="inline-flex justify-center items-center w-12 h-12 rounded-2xl bg-primary/10">
                            <i data-lucide="layout-dashboard" class="w-6 h-6 text-primary"></i>
                        </span>
                    </div>
                    <i data-lucide="grid" class="absolute -right-3 -bottom-3 w-24 h-24 opacity-10"></i>
                </div>
            </article>

            <!-- Kartu 2: Analitik Mendalam (kanan atas) -->
            <article class="overflow-hidden col-span-12 shadow-sm lg:col-span-5 card bg-base-100">
                <div class="flex relative flex-col h-full card-body">
                    <div class="space-y-1">
                    ...
                    <div class="overflow-hidden relative flex-1 mt-4 rounded-xl bg-base-200/60 min-h-28">
                    ...
                    <i data-lucide="bar-chart-3"
                        class="absolute -right-2 -bottom-2 w-20 h-20 opacity-40 text-primary-content"></i>
                </div>
            </article>
            ...
            <article class="overflow-hidden col-span-12 shadow-sm lg:col-span-7 card bg-base-100">
                <div class="flex relative flex-col h-full card-body">
                    ...
                    <i data-lucide="layout-dashboard"
                        class="absolute -right-2 -bottom-2 w-24 h-24 opacity-40 text-primary-content"></i>
                </div>
            </article>
            ...
            <article class="overflow-hidden col-span-12 shadow-sm lg:col-span-5 card bg-base-100">
                <div class="flex relative flex-col h-full card-body">
                    ...
                    <div class="grid flex-1 place-items-center mt-4 rounded-xl bg-base-200/60 min-h-28">
                        <div class="relative w-24 h-24 rounded-lg border-2 border-dashed">
