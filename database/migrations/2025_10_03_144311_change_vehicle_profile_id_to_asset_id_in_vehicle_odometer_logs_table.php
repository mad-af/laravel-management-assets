...
return new class extends Migration
{
    ...
    {
        // Make migration idempotent: only run if legacy column exists
        if (Schema::hasColumn('vehicle_odometer_logs', 'vehicle_profile_id')) {
    ...
    {
        // Only revert if current column is asset_id
        if (Schema::hasColumn('vehicle_odometer_logs', 'asset_id') && !Schema::hasColumn('vehicle_odometer_logs', 'vehicle_profile_id')) {
            Schema::table('vehicle_odometer_logs', function (Blueprint $table) {
